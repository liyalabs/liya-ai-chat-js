var LiyaChat=function(l){"use strict";var _=Object.defineProperty;var R=(l,h,u)=>h in l?_(l,h,{enumerable:!0,configurable:!0,writable:!0,value:u}):l[h]=u;var d=(l,h,u)=>R(l,typeof h!="symbol"?h+"":h,u);let h=null;function u(s){h=s}function x(){if(!h)throw new Error("[LiyaChat] Not initialized. Call LiyaChat.init() first.");return h}async function m(s,e={}){const t=x(),i=`${t.baseUrl}${s}`,n={"X-API-Key":t.apiKey,...e.headers};e.body instanceof FormData||(n["Content-Type"]="application/json");const a=await fetch(i,{...e,headers:n});if(!a.ok){const o=await a.json().catch(()=>({message:"Request failed"}));throw new Error(o.message||`HTTP ${a.status}`)}return a.json()}async function L(s,e,t){const i=x(),n=t&&t.length>0?"/api/v1/external/chat/with-files/":"/api/v1/external/chat/",a=await m(n,{method:"POST",body:JSON.stringify({assistant_id:i.assistantId,message:s,session_id:e,file_ids:t})});if(a.status==="error")throw new Error(a.message||"Failed to send message");return a.data}async function $(s){const e=await m(`/api/v1/external/sessions/${s}/history/`);if(e.status==="error")throw new Error(e.message||"Failed to get history");return e.data}async function E(s){const e=x(),t=await m("/api/v1/external/sessions/",{method:"POST",body:JSON.stringify({assistant_id:e.assistantId,session_name:s||"Yeni Sohbet"})});if(t.status==="error")throw new Error(t.message||"Failed to create session");return t.data}async function B(s,e){const t=new FormData;t.append("session_id",s),t.append("file",e);const i=await m("/api/v1/external/files/",{method:"POST",body:t});if(i.status==="error")throw new Error(i.message||"Failed to upload file");return i.data}function z(s={},e=20,t=20){const i=s.primaryColor||"#6366f1",n=H(i,-10),a=s.backgroundColor||"#ffffff",o=s.textColor||"#374151",c=s.fontFamily||"system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",p=s.borderRadius||"16px";return`
  ...
  `}function H(s,e){const t=parseInt(s.replace("#",""),16),i=Math.round(2.55*e),n=(t>>16)+i,a=(t>>8&255)+i,o=(t&255)+i;return"#"+(16777216+(n<255?n<1?0:n:255)*65536+(a<255?a<1?0:a:255)*256+(o<255?o<1?0:o:255)).toString(16).slice(1)}function T(s){if(!s)return null;try{let e=s.trim();e.startsWith("```json")?e=e.replace(/^```json\s*/,"").replace(/\s*```$/,""):e.startsWith("```")&&(e=e.replace(/^```\s*/,"").replace(/\s*```$/,""));const t=e.match(/\{[\s\S]*\}/);t&&(e=t[0]);const i=JSON.parse(e);return i&&typeof i.response=="string"?i:null}catch{return null}}class v{constructor(e){d(this,"container",null);d(this,"panel",null);d(this,"messagesContainer",null);d(this,"inputElement",null);d(this,"toggleBtn",null);d(this,"isOpen",!1);d(this,"isLoading",!1);d(this,"messages",[]);d(this,"sessionId",null);d(this,"recognition",null);d(this,"isRecording",!1);this.config=e,u(e),this.loadSessionFromStorage(),this.render(),this.attachEvents()}loadSessionFromStorage(){try{this.sessionId=localStorage.getItem("liya_chat_session_id")}catch{}}saveSessionToStorage(e){try{localStorage.setItem("liya_chat_session_id",e)}catch{}}render(){this.container=document.createElement("div"),this.container.className=`liya-chat-widget ${this.config.position||"bottom-right"}`,this.container.id="liya-chat-widget";const e=document.createElement("style"),t=this.config.offsetX??20,i=this.config.offsetY??20;e.textContent=z(this.config.theme,t,i),this.container.appendChild(e),this.toggleBtn=document.createElement("button"),this.toggleBtn.className="liya-toggle-btn",this.toggleBtn.innerHTML=this.getChatIcon(),this.toggleBtn.setAttribute("aria-label","Sohbeti aç"),this.container.appendChild(this.toggleBtn),this.panel=document.createElement("div"),this.panel.className="liya-chat-panel",this.panel.innerHTML=this.getPanelHTML(),this.container.appendChild(this.panel),document.body.appendChild(this.container),this.messagesContainer=this.panel.querySelector(".liya-messages"),this.inputElement=this.panel.querySelector(".liya-input"),this.sessionId&&this.loadHistory()}getPanelHTML(){const e=this.config.assistantName||"Assistant",t=this.config.welcomeMessage||"Bu chat hizmeti Liya AI tarafından sağlanmaktadır. Size bugün nasıl yardımcı olabilirim?",i=this.config.placeholder||"Mesajınızı yazın...",n=this.config.showBranding!==!1,a=this.config.showVoice!==!1,o=this.config.voiceEnabled!==!1,c=this.config.showFileUpload!==!1;return`
